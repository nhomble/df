...
let g:coc_global_extensions = ['coc-json', 'coc-git', 'coc-cmake', 'coc-lists', 'coc-rls', 'coc-tsserver', 'coc-marketplace', 'coc-vimlsp', 'coc-tslint-plugin', 'coc-go', 'coc-lua', 'coc-html', 'coc-pyright']
